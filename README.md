...
Extracting, transforming, and loading data from raw CSV files.

Implemented in SQL (Bronze → Silver → Gold).

✔️ Data Modeling

Building Fact and Dimension tables for analytics workloads.

Creating a clean, intuitive model for business users.
